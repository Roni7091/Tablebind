		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "tablebind",
									"targetURL": "#comexampletablebind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampletablebind-display": {
								"semanticObject": "comexampletablebind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.tablebind",
									"url": sap.ui.require.toUrl("com/example/tablebind")
								}
							}
						}
					}
